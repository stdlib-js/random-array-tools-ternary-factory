...
```javascript
import ternaryFactory from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-tools-ternary-factory@v0.2.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/random-array-tools-ternary-factory/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/random-array-tools-ternary-factory/actions/workflows/test.yml?query=branch:v0.2.3
